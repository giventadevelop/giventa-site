    ...
    <>
        ...
        <section className="banner-section">
          <div className="main-slider-carousel owl-carousel owl-theme">
            ...
            <div className="slide" data-bg="/images/main-slider/image-1.jpg" style={{ backgroundImage: 'url(/images/main-slider/image-1.jpg)' }}>
              ...
              <div className="auto-container">
                ...
                <div className="content-column">
                  <div className="inner-column">
                    <div className="patern-layer-three" style={{ backgroundImage: 'url(/images/main-slider/pattern-3.png)' }}></div>
                    <div className="title">IT Business Consulting</div>
                    <h1>Our Agency Provide <br /> Best IT Solutions</h1>
                    <div className="text">We are 100+ professional software engineers with more than <br /> 10 years of experience in delivering superior products.</div>
                    <div className="btns-box">
                      <a href="/about-us" className="theme-btn btn-style-one"><span className="txt">Learn More</span></a>
                    </div>
                  </div>
                </div>
            ...
            <div className="slide" data-bg="/images/main-slider/image-2.jpg" style={{ backgroundImage: 'url(/images/main-slider/image-2.jpg)' }}>
              <div className="patern-layer-one" style={{ backgroundImage: 'url(/images/main-slider/pattern-1.png)' }}></div>
              <div className="patern-layer-two" style={{ backgroundImage: 'url(/images/main-slider/pattern-2.png)' }}></div>
              <div className="auto-container">
            ...
            <div className="slide" data-bg="/images/main-slider/image-3.jpg" style={{ backgroundImage: 'url(/images/main-slider/image-3.jpg)' }}>
              <div className="patern-layer-one" style={{ backgroundImage: 'url(/images/main-slider/pattern-1.png)' }}></div>
              <div className="patern-layer-two" style={{ backgroundImage: 'url(/images/main-slider/pattern-2.png)' }}></div>
              <div className="auto-container">
          ...
          <div className="auto-container">
            ...
            <div className="row clearfix">
              ...
              <div className="content-column col-lg-6 col-md-12 col-sm-12">
                <div className="inner-column">
                  <div className="text">Does any industry face a more complex audience journey and marketing sales process than B2B technology? Consider the number of people who influence a sale, the length of the decision-making cycle, the competing interests of the people who purchase, implement, manage, and use the technology. It’s a lot meaningful content here.</div>
                  <div className="blocks-outer">
                    ...
                    <div className="feature-block">
                      <div className="inner-box">
                        ...
                        <h6>Experience</h6>
                        <div className="feature-text">Our great team of more than 1400 software experts.</div>
                      </div>
                    </div>
                    ...
                    <div className="feature-block">
                      <div className="inner-box">
                        ...
                        <h6>Quick Support</h6>
                        <div className="feature-text">We’ll help you test bold new ideas while sharing your.</div>
                      </div>
                    </div>
          ...
          <div className="auto-container">
            <div className="row clearfix">
              ...
              <div className="feature-block-two col-lg-6 col-md-12 col-sm-12">
                <div className="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms" style={{ backgroundImage: 'url(/images/resource/feature-1.jpg)' }}>
                  <div className="number">35 +</div>
                  <h4>Worldwide Work Pair</h4>
                  <div className="text">To succeed, every software solution must be deeply integrated into the existing tech environment..</div>
                </div>
              </div>

              {/* Featured Block Two */}
              <div className="feature-block-two col-lg-6 col-md-12 col-sm-12">
                <div className="inner-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms" style={{ backgroundImage: 'url(/images/resource/feature-2.jpg)' }}>
                  <div className="number">40 k</div>
                  <h4>Happy Clients</h4>
                  <div className="text">To succeed, every software solution must be deeply integrated into the existing tech environment..</div>
                </div>
              </div>
              ...
              <div className="row clearfix">
                ...
                <div className="service-block-two col-lg-4 col-md-6 col-sm-12">
                  <div className="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                    ...
                    <div className="text">Create complex enterprise software, ensure reliable software integration, modernise your legacy system.</div>
                  </div>
                </div>
          ...
          <div className="auto-container">
            <div className="row clearfix">
              ...
              <div className="button-column col-lg-4 col-md-12 col-sm-12">
                <div className="inner-column">
                  <a href="/contact-us" className="theme-btn btn-style-two"><span className="txt">Meet With Us</span></a>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="cases-section">
          <div className="auto-container">
            ...
            <div className="btn-box text-center">
              <a href="#" className="theme-btn btn-style-three"><span className="txt">View All</span></a>
            </div>
          ...
          <div className="auto-container">
            ...
            <div className="carousel-outer">
              ...
              <ul className="sponsors-carousel owl-carousel owl-theme">
                <li><div className="image-box"><a href="#"><img src="/images/clients/1.png" alt="" /></a></div></li>
                <li><div className="image-box"><a href="#"><img src="/images/clients/2.png" alt="" /></a></div></li>
                <li><div className="image-box"><a href="#"><img src="/images/clients/3.png" alt="" /></a></div></li>
                <li><div className="image-box"><a href="#"><img src="/images/clients/4.png" alt="" /></a></div></li>
                <li><div className="image-box"><a href="#"><img src="/images/clients/1.png" alt="" /></a></div></li>
                <li><div className="image-box"><a href="#"><img src="/images/clients/2.png" alt="" /></a></div></li>
                <li><div className="image-box"><a href="#"><img src="/images/clients/3.png" alt="" /></a></div></li>
                <li><div className="image-box"><a href="#"><img src="/images/clients/4.png" alt="" /></a></div></li>
        ...
        <section className="technology-section" style={{ backgroundImage: 'url(/images/background/1.jpg)' }}>
          <div className="pattern-layer-one" style={{ backgroundImage: 'url(/images/background/pattern-5.png)' }}></div>
              ...
              <div className="blocks-column col-lg-7 col-md-12 col-sm-12">
                <div className="inner-column">
                  <div className="row clearfix">
                    ...
                    {/* Technology Block */}
                    <div className="technology-block col-lg-4 col-md-6 col-sm-12">
                      <div className="inner-box">
                        <a href="services-detail.html" className="overlay-link"></a>
                        <div className="icon-box">
                          <span className="flaticon-coding-2"></span>
                        </div>
                        <h6>WEB</h6>
                      </div>
                    </div>
                    ...
                    <div className="technology-block col-lg-4 col-md-6 col-sm-12">
                      <div className="inner-box">
                        <a href="services-detail.html" className="overlay-link"></a>
                        <div className="icon-box">
                          <span className="flaticon-smartband"></span>
                        </div>
                        <h6>WEARALABLES</h6>
                      </div>
                    </div>
        ...
        {/* Team Section */}
        <section className="team-section" style={{ backgroundImage: 'url(/images/background/2.jpg)' }}>
          <div className="auto-container">
            {/* Sec Title */}
            <div className="sec-title">
              <div className="clearfix">
                <div className="pull-left">
                  <div className="title">OUR DEDICATED TEAM</div>
